...
<body class="page-homepage-carousel">
    ...
    <div class="wrapper">
        ...
        <form method="post" action="EditDA" id="aspnetForm">
...
<script type="text/javascript" src="./js/mojosuperfish.js"></script>
            ...
            <div class="container">
                ...
                <div class="col-md-12">
                            <div class="card">
                                <form method="post" action="EditDA" class="form-horizontal">
                                <% DuAn duan = (DuAn) request.getAttribute("duan"); %>
                                    <div class="card-header card-header-text" data-background-color="rose">
									<button type="button" rel="tooltip" class="btn btn-warning" style = "border-radius: 5px;">Chỉnh sửa dự án</button>
									<br>
                                    </div>
                                   		...
                                   		<div style = "float: left">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px; border-radius: 5px;" name = "maduan" value ="<%= duan.getMaDA()%>">
                                                </div>
                                            </div>
										</div>
										<div style = "float: left">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px; border-radius: 5px;" name = "tenduan" value = "<%= duan.getTenDA()%>">
                                                </div>
                                            </div>
										</div>
										<div style = "padding-left: 600px;">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px; border-radius: 5px;" name = "vitri" value = "<%= duan.getVitriDA()%>">
                                                </div>
                                            </div>
										</div>
									</div>
										...
										<div style = "float: left">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name = "dientich" value = "<%= duan.getDienTich()%>">
                                                </div>
                                            </div>
										</div>
										<div style = "padding-left: 600px;">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name = "toanha" value = "<%= duan.getTongSoToaNha()%>">
                                                </div>
                                            </div>
										</div>
									</div>
									<div>
										<div style = "float: left">
											<label class="col-sm-3 label-on-left">Mật độ</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px; border-radius: 5px;" name = "matdo" value = "<%= duan.getMaDoXD()%>">
                                                </div>
                                            </div>
										</div>
										...
										<label class="col-sm-3 label-on-left">Giai đoạn</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px; border-radius: 5px;" name = "giaidoan" value = "<%= duan.getGiaiDoan()%>">
                                                </div>
                                            </div>
										</div>
									</div>
						...
						<button type="button" rel="tooltip" class="btn btn-info" style="float: right; border-radius: 8px;margin-left: 10px;">Quay lại</button>
