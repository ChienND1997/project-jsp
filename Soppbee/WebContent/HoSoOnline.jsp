...
Login users = null ;
 ...
 if(session.getAttribute("ipUserName") != null) {
	...
	ShowHosoDAO show = new ShowHosoDAO();
...
<body class="page-homepage-carousel">
        ...
        <form action="SendMailServlet" method="post">         
            <div class="col-md-12">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="myTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-right">Công ty</th>
                            ...
                            for (HoSoOnline list : show.getListHoSo()) {
                        ...
                        %>
                                                <tr>                                               
                                                    ...
                                                    <td><%= list.getCMND() %></td>                       				
                                  					<td> <%= list.getDuan() %></td>
                                  					<td><%= list.getNghenghiep() %></td>
                                  					<td class="text-right"><%= list.getThunhap() %></td>
                                                    <td class="text-right"><%= list.getDoituong() %></td>
                                                    <td class="text-right"><%= list.getCongty() %></td>
                                                    <td class="text-right"><%= list.getEmail() %></td>
                                                     <td class="td-actions text-right">
                                                     
                                                  <input type="hidden" name = "them" value="them">
                                                    
                                                      <input type="submit"   rel="tooltip" class="btn btn-info" style="border-radius: 8px;">                                                     
