...
<body class="page-homepage-carousel">
    ...
    <div class="wrapper">
        ...
        <form method="post" action="EditCD" id="aspnetForm">
...
<script type="text/javascript" src="./js/mojosuperfish.js"></script>
            ...
            <div class="container">
                ...
                <div class="col-md-12">
                            <div class="card">
                                <form method="post" action="EditCD" class="form-horizontal">
                                <% NguoiMua nm = (NguoiMua) request.getAttribute("nguoiMua"); %>
                                    <div class="card-header card-header-text" data-background-color="rose">
									<button type="button" rel="tooltip" class="btn btn-warning" style = "border-radius: 5px;">Chỉnh sửa hồ sơ người mua nhà</button>
									<br>
                                    </div>
										...
										<div style = "float: left">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px; border-radius: 5px;" name = "hoten" value ="<%=nm.getHoTen()%>">
                                                </div>
                                            </div>
										</div>
										<div style = "padding-left: 600px;">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px; border-radius: 5px;" name = "sdt" value = "<%= nm.getSDT()%>">
                                                </div>
                                            </div>
										</div>
									</div>
										...
										<div style = "float: left">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name = "cmnd" value = "<%= nm.getCMND() %>">
                                                </div>
                                            </div>
										</div>
										<div style = "padding-left: 600px;">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name = "tenphong" value = "<%= nm.getTenPhong()%>"">
                                                </div>
                                            </div>
										</div>
									</div>
										...
										<label class="col-sm-3 label-on-left">Địa chỉ</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                                    ...
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px; border-radius: 5px;" name = "diachi" value = "<%= nm.getDiaChi()%>">
                                                </div>
                                            </div>
										</div>
									</div>
