...
<link rel="shortcut icon" href="images/favicon.png">
    ...
    <div id="map"></div>
      ...
      <script type="text/javascript">var m= L.map('map').setView([20.993383, 105.86633], 16);
var osmDataAttr = 'Map data &copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors';
      ...
      var marker = L.marker([20.993668, 105.867851]).addTo(m);
      var polygon = L.polygon([
    	  [20.998333, 105.868334],
    	  [20.996521, 105.870255],
    	  [20.990411, 105.870212],
    	  [20.990441, 105.866575],
    	  [20.991102, 105.865717],
    	  [20.993025, 105.865588],
    	  [20.996931, 105.865910],
    	  [20.996941, 105.866843],
    	  [20.996951, 105.866854],
    	]).addTo(m);
      mq.addTo(m);
      marker.bindPopup("Vị trí dự án").openPopup();
      var baseMaps = {
          "Mapbox Streets": mq,
          "Open Street Map":osm
      };
