...
<head>
    ...
    <title>Dự ấn sắp hoàn thiện</title>
            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    <li class="nav-item ">
                     ...
                     <li class="nav-item">
                        <a class="nav-link"  href="dangkymuanha.jsp">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="BaiBao.jsp">
            ...
            <nav class="navbar navbar-expand-lg ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="#pablo">Dự án sắp hoàn thiện</a>
                    </div>
                                ...
                                <div class="card-body table-striped table-no-bordered table-hover dataTable dtr-inline table-full-width">
                                    ...
                                    <div class="fresh-datatables">
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                           ...
                                           <%
                                           for(DuAn list : show.getListDuanSapHoanThien()){
                                           %> 
                                                <tr>
                                                    <td><%= list.getTenDA() %></td>
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <a href="#" class="btn btn-link btn-danger remove"><i class="fa fa-edit"></i></a>
                                                    </td>
                                                </tr>
                                                <%} %>
                                            </tbody>
