...
<link rel="canonical" href="TrangChuCD.jsp"></head>
<body class="page-homepage-carousel">
    <!-- Wrapper -->
    <div class="wrapper">
        
        <form method="get" action="TrangChuCD.jsp" id="aspnetForm">
                                        ...
                                        <li class="trangchu limenu active nopdding"><a href="TrangChuCD.jsp" title="Trang chủ" class=" no-link">
                                           <p class="hidden-xs hidden-sm">Trang chủ</p>
                                            <i class="fa fa-home hidden-lg hidden-md"></i></a></li>
											  <li class="dukhach limenu nopdding to"><a href="dangkymuanha.jsp" title="Quỹ tín dụng địa phương" class=" no-link"><i class="fa fa-users hidden-lg hidden-md"></i>
                                            <p class="hidden-xs hidden-sm">Đăng ký hồ sơ xét tuyển</p>
                                        </a></li>
                        ...
                        <div class="col-md-12 nopadding">
                            <div class="tab-content-slide">
                                <div class="tab-pane-slide active" id="tab01">
                                    <div class="col-md-12 nopadding">
                                        <div class="col-md-4">
                                            <a href="DuAnDangTrienKhaiCD.jsp" class="appBox">
                                                <img class="col-md-12 col-xs-12" src="./images/doanhnghiep-duandautu.jpg">
                                            </a>
                                            <div class="col-md-12 col-xs-12 ">
                                                <a href="DuAnDangTrienKhaiCD.jsp">
                                        ...
                                        <div class="col-md-4 col_last ">
                                            <a href="DuAnSapHoanThienCD.jsp" class="appBox">
                                                <img class="col-md-12 col-xs-12" src="./images/doanhnghiep-trienkhaiduan.jpg">
                                            </a>
                                            <div class="col-md-12 col-xs-12 ">
                                                <a href="DuAnSapHoanThienCD.jsp">
                                        ...
                                        <div class="col-md-4">
                                            <a href="DuAnDaHoanThanhCD.jsp" class="appBox">
                                                <img class="col-md-12 col-xs-12" src="./images/dulich-danhlam.jpg">
                                            </a>
                                            <div class="col-md-12 col-xs-12 ">
                                                <a href="DuAnDaHoanThanhCD.jsp">
                                                    <h4 class="title-gishue">Dự án đã hoàn thành</h4>
                                                </a>
                                                <p>Cung cấp các thông tin về dự án</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="image-carousel">
                                <div class="image-carousel-slide">
                                    <a href="TrangChuCD.jsp" target="_blank" title="Kênh phản ảnh hiện trường">
