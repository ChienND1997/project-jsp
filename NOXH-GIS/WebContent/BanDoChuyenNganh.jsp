...
<body class="page-homepage-carousel">
    ...
    <div class="wrapper">
        ...
        <form method="get" action="TrangChu.jsp" id="banDoForm">
</script>
        ...
        <div id="treeRightExplorer" class="col-md-9">
          <div id="page-main">
            <section id="right-sidebar">
			  ...
			  <div class="image-wrapper"><a onclick="fnXemUngDung(&#39;2099FBB0-AFC0-4F0A-83F3-F79827ACB6AF&#39;)" href=""><img src="./images/anhDaiDien(3).png"></a></div>
			  <div class="stick-to-bottom"><div class="feature-des"></div><a onclick="fnXemUngDung(&#39;2099FBB0-AFC0-4F0A-83F3-F79827ACB6AF&#39;)" class="btn btn-framed btn-color-grey btn-small">Chi tiết</a></div><div class="background featuredBg"></div></figure>
...
@media (min-width:320px) {
    ...
    .display .buttonRefresh { 
        ...
        font-size: 12px;
        background: url('/gClient/gExplorer/Resources/images/refeshicon.png') center left no-repeat;
        height: 24px;
        cursor: pointer;
