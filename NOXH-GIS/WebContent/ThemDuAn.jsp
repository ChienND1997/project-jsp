...
<% 
	...
	AddCDTDAO add = new AddCDTDAO();
	ShowDADAO show = new ShowDADAO();
	ShowMaDVTN_DAO addDvtn = new ShowMaDVTN_DAO();
	ShowMaDVTC_DAO addDvtc = new ShowMaDVTC_DAO();
	Login users = null;
...
<body class="page-homepage-carousel">
    ...
    <div class="wrapper">
        ...
        <form method="post" action="AddDA" id="aspnetForm">
...
<script type="text/javascript" src="./js/mojosuperfish.js"></script>
            ...
            <div class="container">
                ...
                <div class="col-md-12">
                            <div class="card">
                                <form method="post" action="AddDA" class="form-horizontal">
                                    <div class="card-header card-header-text" data-background-color="rose">
									<button type="button" rel="tooltip" class="btn btn-warning" style = "border-radius: 5px;">Thêm hồ sơ dự án chờ xét duyệt</button>
									<br>
                                    </div>
                                    <div class="card-content">
                                    <div>
										<div style = "float: left">
											<label class="col-sm-3 label-on-left">Mã dự án</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px; border-radius: 5px;" name = "maduan">
                                                </div>
                                            </div>
										</div>
										<div style = "padding-left: 600px;">
											<label class="col-sm-3 label-on-left">Tên dự án</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px; border-radius: 5px;" name = "tenduan">
                                                </div>
                                            </div>
										</div>
									</div>
                                    <div>
										<div style = "float: left">
											<label class="col-sm-3 label-on-left">Diện tích</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;"  name = "dientich">
                                                </div>
                                            </div>
										</div>
										<div style = "padding-left: 600px;">
											<label class="col-sm-3 label-on-left">Vị trí </label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name = "vitri">
                                                </div>
                                            </div>
										</div>
									</div>
									<div>
										<div style = "float: left">
											<label class="col-sm-3 label-on-left">Tòa nhà </label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name ="toanha">
                                                </div>
                                            </div>
										</div>
										<div style = "padding-left: 600px;">
											<label class="col-sm-3 label-on-left">Mật độ xây dựng</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name ="matdoxd">
                                                </div>
                                            </div>
										</div>
									</div>
										<div>
										<div style = "float: left">
											<label class="col-sm-3 label-on-left">Kinh độ</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name = "kinhdo">
                                                </div>
                                            </div>
										</div>
										<div style = "padding-left: 600px;">
											<label class="col-sm-3 label-on-left">Vĩ độ</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name = "vido">
                                                </div>
                                            </div>
										</div>
									</div>
									...
									<div>
										<div style = "float: left">
											<label class="col-sm-3 label-on-left">Số căn hộ</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name = "socanho">
                                                </div>
                                            </div>
										</div>
										<div style = "padding-left: 600px;">
											<label class="col-sm-3 label-on-left">Vốn đầu tư</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name = "vondautu">
                                                </div>
                                            </div>
										</div>
									</div>
									<div>
										<div style = "float: left">
											<label class="col-sm-3 label-on-left">Năm bắt đầu</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name = "nambatdau">
                                                </div>
                                            </div>
										</div>
										<div style = "padding-left: 600px;">
											<label class="col-sm-3 label-on-left">Năm hoàn thành</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name = "namhoanthanh">
                                                </div>
                                            </div>
										</div>
									</div>
									<div>
										<div style = "float: left">
											<label class="col-sm-3 label-on-left">Giá bán</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name = "giaban"/>
                                                </div>
                                            </div>
										</div>
										<div style = "padding-left: 600px;">
											<label class="col-sm-3 label-on-left">Giá thuê</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name = "giathue">
                                                </div>
                                            </div>
										</div>
									</div>
									<div>
										<div style = "padding-left: 600px;">
											<label class="col-sm-3 label-on-left">Tên chủ đầu tư</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name = "tencdt">
                                                </div>
                                            </div>
										</div>
									</div>
									<div>
									<div style = "float: left">
       										<label class="col-sm-3 label-on-left">Mã Chủ đầu tư</label>

                                            <div class="col-sm-10">
											
                                                <select class="form-group label-floating is-empty" style = "float: left; width: 500px; height: 40px; border-radius: 5px;" name ="chudautu">
                                                
												 <% for(ChuDauTu list : add.getListChudautu()){ %>
												 
												    <option value="<%= list.getMaCDT() %>" >
												   <%= list.getMaCDT()%> 
										 ...
										 <div style = "float: left">
       										<label class="col-sm-3 label-on-left">Mã đơn vị tài chính</label>

                                            <div class="col-sm-10">
											
                                                <select class="form-group label-floating is-empty" style = "float: left; width: 500px; height: 40px; border-radius: 5px;" name ="madvtc">
                                                
												 <% for(DonViQuanLyTC list : show.getListTaiChinh()){ %>
												 
												    <option value="<%= list.getMaDVTC() %>" >
												   <%= list.getMaDVTC()%> 
										...
										<div style = "padding-left: 600px;">
											<label class="col-sm-3 label-on-left">Giai đoạn</label>
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty">
                                            
                                                    <input type="text" class="form-control" style = "height: 20px; width: 500px;  border-radius: 5px;" name ="giaidoan">
                                                </div>
                                            </div>
										</div>
									</div>
									<div>
										<div style = "float: left">
       										<label class="col-sm-3 label-on-left">ĐV Thi Công</label>
            								   <div class="col-sm-10">
													<div class="form-group label-floating is-empty" >
           											 <input type="text" class="form-control" style = "float: left; width: 500px; height: 40px; border-radius: 5px;" name = "dvthicong">
     											 </div>
    											 </div>
										 </div>
										 <div>
										<div style = "float: left">
       										<label class="col-sm-3 label-on-left">Diện Tích Căn hộ</label>
            								   <div class="col-sm-10">
													<div class="form-group label-floating is-empty" >
           											 <input type="text" class="form-control" style = "float: left; width: 500px; height: 40px; border-radius: 5px;" name = "dtcanho">
     											 </div>
    											 </div>
										 </div>
									<div style = "float: left">
       										<label class="col-sm-3 label-on-left">Mã đơn vị tài nguyên</label>

                                            <div class="col-sm-10">
											
                                                <select class="form-group label-floating is-empty" style = "float: left; width: 500px; height: 40px; border-radius: 5px;" name ="dvtainguyen">
                                                
												 <% for(DonViQuanLyTN list : addDvtn.getListDonviQLTN()){ %>
												 
												    <option value="<%= list.getMaDVTN()%>" >
												   <%= list.getMaDVTN() %> 
									...
									<div>
										<div style = "float: left">
       										<label class="col-sm-3 label-on-left">Mã Tài chính</label>
            								<div class="col-sm-10">
											
                                                <select class="form-group label-floating is-empty" style = "float: left; width: 500px; height: 40px; border-radius: 5px;" name ="mataichinh">
                                                
												 <% for(DonViQuanLyTC list : addDvtc.getListDonviQLTC()){ %>
						...
						<a href = "QuanLyDuAn.jsp"><button type="button" rel="tooltip" class="btn btn-info" style="float: right; border-radius: 8px;margin-left: 10px;">Quay lại</button></a>
